...
public class MainStyle2Activity extends Activity {
	...
	public void init(){
		gridview=(GridView)findViewById(R.id.gridView_style2);
		navigationBar=(NavigationBar)findViewById(R.id.navigationBar_style2);
		initGridView();
		initNavigationBar();
	}
	...
	public void initGridView(){
		...
		item.put("text", "drink");
		item2.put("image", R.drawable.p1_11);
		item2.put("text", "drink2");
		item3.put("image", R.drawable.p1_1);
		item3.put("text", "drink");
		item4.put("image", R.drawable.p1_11);
		item4.put("text", "drink2");
		item5.put("image", R.drawable.p1_1);
		...
		SimpleAdapter adapter=new SimpleAdapter(MainStyle2Activity.this, datasource, 
